...
namespace WebHost.Configuration
{
    public class CustomViewService : IViewService
    {
        ...
        public virtual Task<System.IO.Stream> ClientPermissions(Thinktecture.IdentityServer.Core.ViewModels.ClientPermissionsViewModel model)
        {
            return Render(model, "permissions");
        }

        public virtual Task<System.IO.Stream> Consent(Thinktecture.IdentityServer.Core.ViewModels.ConsentViewModel model)
        {
            return Render(model, "consent");
        }

        public virtual Task<System.IO.Stream> Error(Thinktecture.IdentityServer.Core.ViewModels.ErrorViewModel model)
        {
            return Render(model, "error");
        }

        public virtual Task<System.IO.Stream> LoggedOut(Thinktecture.IdentityServer.Core.ViewModels.LoggedOutViewModel model)
        {
            return Render(model, "loggedOut");
        }

        public virtual async Task<System.IO.Stream> Login(Thinktecture.IdentityServer.Core.ViewModels.LoginViewModel model, Thinktecture.IdentityServer.Core.Models.SignInMessage message)
        {
        ...
        public virtual Task<System.IO.Stream> Logout(Thinktecture.IdentityServer.Core.ViewModels.LogoutViewModel model)
        {
